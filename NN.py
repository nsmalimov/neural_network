...
def train_one_back(matrix_dist, x_array, true_answer, w_matrix, num_layers, is_shake_up):
    ...
    error_array = [count_error(y_array[0], result_front[0]), count_error(y_array[1], result_front[1]),
                   count_error(y_array[2], result_front[3]), count_error(y_array[3], result_front[3])]
